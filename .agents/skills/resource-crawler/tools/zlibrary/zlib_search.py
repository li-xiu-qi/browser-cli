...
class ZLibrarySearchTool:
    ...
    def show_login_guide(self):
        ...
        print("=" * 70)
        print("步骤 1: 运行登录脚本")
        print("   .venv\\Scripts\\python.exe .agents\\skills\\zlibrary-to-notebooklm\\scripts\\login.py")
        print("")
        ...
        print("")
        print("步骤 3: 重新运行搜索")
        print("   .venv\\Scripts\\python.exe .agents\\skills\\zlibrary-to-notebooklm\\zlib_search.py \"书名\"")
        print("=" * 70)
