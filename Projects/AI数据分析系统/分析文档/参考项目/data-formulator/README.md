...
- [04-23-2025] Data Formulator 0.2: working with *large* data 
  - Explore large data by:
    ...
    2. Use drag-and-drop to specify charts, and Data Formulator dynamically fetches data from the database to create visualizations (with ️️️ speeds).
...
- [03-20-2025] Data Formulator 0.1.7: Anchoring ︎
  ...
  - Clean a data and work with only the cleaned data; create a subset from the original data or join multiple data, and then go from there. AI agents will be less likely to get confused and work faster. ️️
