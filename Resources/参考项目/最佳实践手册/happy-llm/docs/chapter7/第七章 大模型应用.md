...
文档可以是文章、书籍、对话、代码等文本内容，例如pdf文件、md文件、txt文件等。完整代码可以在 ***[RAG/utils.py](Projects/内容创作/草稿箱/docs/参考文献/happy-llm/docs/chapter7/RAG/utils.py)*** 文件中找到。该代码支持加载pdf、md、txt等类型的文件，只需编写相应的函数即可。
...
完整代码可以在 ***[/VectorBase.py](VectorBase.py)*** 文件中找到。
