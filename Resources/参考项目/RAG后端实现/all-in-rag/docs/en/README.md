...
2. [x] [Preparation](Projects/内容创作/草稿箱/docs/参考文献/all-in-rag/docs/en/chapter1/02_preparation.md) - Environment configuration and tool preparation
...
![Project I](Projects/内容创作/草稿箱/docs/参考文献/all-in-rag/docs/project01.png)

### Chapter 9 Project I (Graph RAG Optimization):

![Project I (Graph RAG Optimization)](Projects/内容创作/草稿箱/docs/参考文献/all-in-rag/docs/project01_graph.png)
