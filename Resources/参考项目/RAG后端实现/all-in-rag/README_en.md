...
## Project Introduction（[中文](Projects/内容创作/草稿箱/docs/参考文献/all-in-rag/README.md) | English）
...
1. [x] [RAG Introduction](Projects/内容创作/草稿箱/docs/参考文献/all-in-rag/docs/en/chapter1/01_RAG_intro.md) - RAG technology overview and application scenarios
2. [x] [Preparation](Projects/内容创作/草稿箱/docs/参考文献/all-in-rag/docs/en/chapter1/02_preparation.md) - Environment configuration and preparation
3. [x] [Four Steps to Build RAG](Projects/内容创作/草稿箱/docs/参考文献/all-in-rag/docs/en/chapter1/03_get_start_rag.md) - Quick start with RAG development
...
![Project I](Projects/内容创作/草稿箱/docs/参考文献/all-in-rag/project01.png)

### Chapter 9 Project I (Graph RAG Optimization):

![Project I (Graph RAG Optimization)](Projects/内容创作/草稿箱/docs/参考文献/all-in-rag/project01_graph.png)
