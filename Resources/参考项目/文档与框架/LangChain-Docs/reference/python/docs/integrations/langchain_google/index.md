...
- :simple-googlecloud:{ .lg .middle } __Vertex AI Platform__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/integrations/langchain_google_vertexai/index.md)
...
- :fontawesome-solid-people-group:{ .lg .middle } __Community__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/integrations/langchain_google_community/index.md)
