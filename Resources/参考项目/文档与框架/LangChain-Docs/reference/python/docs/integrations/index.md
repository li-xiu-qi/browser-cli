...
- :fontawesome-brands-openai:{ .lg .middle } __`langchain-openai`__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/integrations/langchain_openai/index.md)
...
- :simple-claude:{ .lg .middle } __`langchain-anthropic`__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/integrations/langchain_anthropic/index.md)
...
- :simple-googlegemini:{ .lg .middle } __`langchain-google-genai`__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/integrations/langchain_google_genai/index.md)
