...
Most users will primarily interact with the main [`langchain`](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/langchain/langchain/index.md) package, which provides the complete set of implementations for building LLM applications. The packages below form the foundation of the LangChain ecosystem, each serving a specific purpose in the architecture:
...
- :simple-langchain:{ .lg .middle } __`langchain`__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/langchain/langchain/index.md)
...
- :material-atom:{ .lg .middle } __`langchain-core`__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/langchain_core/index.md)
...
- :material-format-text:{ .lg .middle } __`langchain-text-splitters`__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/langchain_text_splitters/index.md)
...
- :fontawesome-solid-down-left-and-up-right-to-center:{ .lg .middle } __`langchain-mcp-adapters`__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/langchain_mcp_adapters/index.md)
...
- :material-test-tube:{ .lg .middle } __`langchain-tests`__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/langchain_tests/index.md)
...
- :fontawesome-solid-building-columns:{ .lg .middle } __`langchain-classic`__
    ...
    [:octicons-arrow-right-24: Reference](Projects/内容创作/草稿箱/docs/参考文献/docs/reference/python/docs/langchain_classic/index.md)
